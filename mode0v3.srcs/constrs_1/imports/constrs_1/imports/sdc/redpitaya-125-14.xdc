...
set_property PULLDOWN TRUE [get_ports {exp_n_io[2]}]
set_property PULLDOWN TRUE [get_ports {exp_n_io[3]}]
set_property PULLDOWN TRUE [get_ports {exp_n_io[4]}]
set_property PULLDOWN TRUE [get_ports {exp_n_io[5]}]
set_property PULLDOWN TRUE [get_ports {exp_n_io[6]}]
set_property PULLDOWN TRUE [get_ports {exp_n_io[7]}]
